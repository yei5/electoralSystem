...
{
    default String queryVotingTable(String votantId)
    {
        return queryVotingTable(votantId, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String queryVotingTable(String votantId, java.util.Map<String, String> context)
    {
        return _iceI_queryVotingTableAsync(votantId, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> queryVotingTableAsync(String votantId)
    {
        return _iceI_queryVotingTableAsync(votantId, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> queryVotingTableAsync(String votantId, java.util.Map<String, String> context)
    {
        return _iceI_queryVotingTableAsync(votantId, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_queryVotingTableAsync(String iceP_votantId, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "queryVotingTable", null, sync, null);
    ...
    {
        return "::electoralSystem::QueryServer";
    }
}
